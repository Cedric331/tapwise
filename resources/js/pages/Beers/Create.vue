...
const submit = () => {
    form.post(`/bars/${props.bar.slug}/beers`);
};
        ...
        <div class="min-h-screen bg-[#FDFDFC]">
            <div class="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
                <div class="mb-10">
                    ...
                    <p class="text-sm font-medium text-amber-800">Nouvelle bière</p>
                    <h1 class="mt-3 text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">Ajouter une bière</h1>
                    <p class="mt-3 text-lg text-gray-600">Remplissez les informations de votre nouvelle bière.</p>
                ...
                <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    rows="3"
                                    class="block w-full rounded-lg border border-amber-200 px-4 py-2.5 text-sm focus:border-amber-500 focus:outline-none focus:ring-2 focus:ring-amber-200"
                                    placeholder="Une IPA moderne aux arômes d'agrumes..."
                                />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="rounded-3xl border border-amber-100 bg-white p-6 shadow-sm">
                        ...
                        <p class="mb-6 text-sm text-gray-600">Affinez le profil pour des recommandations plus pertinentes.</p>
                    ...
                    <div class="flex justify-end gap-4">
                        ...
                        >
                            ...
                            <span v-else>Créer la bière</span>
                        </button>
                    </div>
                </form>
            </div>
