...
const form = useForm({
    ...
    grape: props.wine.grape ?? '',
    region: props.wine.region ?? '',
    food_pairings: props.wine.food_pairings ?? [],
    abv_x10: props.wine.abv_x10,
    description: props.wine.description || '',
    is_available: props.wine.is_available,
    price: props.wine.price,
    tags: props.wine.tags.map((t) => t.id),
});

const submit = () => {
    form.put(`/bars/${props.bar.slug}/wines/${props.wine.id}`);
};
        ...
        <div class="min-h-screen bg-[#FDFDFC]">
            <div class="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
                <div class="mb-10">
                    ...
                    <h1 class="mt-3 text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">Modifier un vin</h1>
                    <p class="mt-3 text-lg text-gray-600">{{ wine.name }}</p>
